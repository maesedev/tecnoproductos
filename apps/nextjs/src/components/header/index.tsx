  ...
  return (
    <nav className="sticky left-0 top-0  z-20 w-full border-b border-gray-200 bg-white dark:border-gray-600 dark:bg-gray-900">
      <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
        <a href="/" className="">
          <Image src={Logo} width={50} height={50} className="mr-3 h-8" alt="Flowbite Logo" />
        </a>
        ...
        <div className="flex gap-x-5 md:order-2">
          <button type="button" className="group flex shrink-0 items-center rounded-lg transition">
            ...
            <Image alt="Man" src={SpaceShip} className="h-10 w-10 rounded-full object-cover" />
          ...
          {Session ? (
            <div className="h-10 w-10 overflow-hidden rounded-full border-2 border-pink-400 ">
              <a href="/checkout">
